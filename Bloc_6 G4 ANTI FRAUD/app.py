...
def main():
    ...
    with col_left:
        ...
        st.markdown("<div class='col-header'>2. AUDIT UNITAIRE JSON</div>", unsafe_allow_html=True)
        ...
        st.markdown("<br><br>", unsafe_allow_html=True)
        st.markdown("<div class='col-header'>3. AUDIT DE MASSE CSV</div>", unsafe_allow_html=True)
