"""
Script one-shot : logue les métriques du modèle dans mlflow.db (SQLite).
Lance avec : python setup_mlflow_db.py
"""
import os
import mlflow
...
# Run 1 : modèle final (métriques issues du notebook principal)
with mlflow.start_run(run_name="xgboost-final"):
    ...
    mlflow.log_metrics({
        ...
        "false_positives": 721,
        "false_negatives": 173,
        "true_negatives":  57896,
    })
    print("Run 1/4 loggé : xgboost-final")

# Runs 2-4 : comparaison de seuils
scenarios = [
...
print("Lance maintenant : python start_mlflow.py")
